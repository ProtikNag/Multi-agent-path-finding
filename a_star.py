...
def a_star(grid, start, goal):
    """A* algorithm to find the shortest path from start to goal in the grid."""
...
def process_files(data_folder):
    ...
    for file_name in os.listdir(data_folder):
        if file_name.endswith(".txt"):
            ...
            # Run A* for each agent and measure time
            agent_paths = []
...
# Main processing
data_folder = "./Data"
output_csv = "agent_collision_results_a_star.csv"
